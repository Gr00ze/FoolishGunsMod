...
public class IonBallEntityLegacy extends ShulkerBullet {
    ...
    public IonBallEntityLegacy(EntityType<? extends IonBallEntityLegacy> entityType, Level level) {
        super(entityType, level);
        this.noPhysics=true;
    }
    //@Override
    public IonBallEntityLegacy(Level level, LivingEntity shooter, Entity finalTarget, Direction.Axis axis) {
